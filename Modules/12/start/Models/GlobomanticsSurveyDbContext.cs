...
namespace Globomantics.Survey.Models
{
    public class GlobomanticsSurveyDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Guid rangeSurvey = new Guid("8f8afc29-228d-4508-9f7a-7d17c4ae9000");
            ...
            modelBuilder.Entity<SurveyQuestion>()
                .HasData(
                    ...
                    new SurveyQuestion(surveyId, new Guid("8f8afc29-228d-4508-9f7a-7d17c4ae9904"), "Any comments on how you find working for Carved Rock?", ""),
                    new SurveyQuestion(rangeSurvey, new Guid("8f8afc29-228d-4508-9f7a-7d17c4ae9001"), "Rate us bad - good")
                );
            ...
            modelBuilder.Entity<GloboSurveyUserTicket>().HasData(
                new GloboSurveyUserTicket { 
                    Id = Guid.NewGuid().ToString(),
                    UserId = new Guid("8f8afc29-228d-4508-9f7a-7d17c4ae9901").ToString(), 
